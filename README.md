...
- ChampionCreator 由来の公式イラスト asset を、UI 補助画像として最小範囲だけ `public/assets/official-artwork/` にコピー済み
...
画像は `@smogon/calc` 由来ではなく、ChampionCreator 由来 options の `artwork` パスに対応する UI 補助 asset として扱う。
M6 では全量コピーせず、表示に使う最小範囲だけ次へコピーしている。

- `public/assets/official-artwork/25.png`
- `public/assets/official-artwork/7.png`
